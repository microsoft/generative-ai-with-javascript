...
> [!NOTE]  
> While we recommend going through the story (it's fun!), [click here](#interact-with-dinocrates) if you'd prefer to jump straight to the technical content.
...
![London Workshop](https://raw.githubusercontent.com/microsoft/generative-ai-with-javascript/main/lessons/01-intro-to-genai/assets/london.png)
